    ...
    <section id="homepage" class="focus_layout">
        <div class="content-wrap">
            <div class="hotnews">
                ...
                <time datetime="2018-09-19 20:48+0700" pubdate>Cập nhật </time>
            </div>
            <section class="featured">
                ...
                <article class=" hasvideo noads" topic-id="2000,2208,4150,4223,4614">
                    <p class="type"></p>
                    <div class="cover">
            ...
            <section class="trending scroll">
                <div class="top-list">
                    <article class=" hasvideo" topic-id="2001,2020,2369">
                        <p class="type"></p>
                        <div class="cover">
                            <a href="/hagl-gio-phai-lo-tru-hang-sau-tran-thua-clb-ha-noi-post878222.html">
                                <img src="https://znews-photo-td.zadn.vn/w210/Uploaded/pgi_ubnvgunau/2018_09_19/phuong11.jpg" alt="‘HAGL gio phai lo tru hang sau tran thua CLB Ha Noi’ hinh anh" title="‘HAGL giờ phải lo trụ hạng sau trận thua CLB Hà Nội’ hình ảnh">
                            </a>
                        </div>
                        <header>
                            <p class="title">
                ...
                <article class="" topic-id="2001,2020,2369,4520,4521,4522">
                    <p class="type"></p>
                    <header>
                        <p class="title">
                ...
                <article class="" topic-id="2001,2020,2208,2225,2657,4150,4441">
                    <p class="type"></p>
                    <header>
                        <p class="title">
                ...
                <article class=" video" topic-id="2020">
                    <p class="type"></p>
                    <header>
                        <p class="title">
                ...
                <article class=" hasvideo" topic-id="2020,3919,4590,4613">
                    <p class="type"></p>
                    <header>
                        <p class="title">
        ...
        <section id="multi" class="section">
            ...
            <div class="article-list magazine-layout2">
                <article article-id="877659" class="article-item type-picture" topic-id="2002,2020,4465">
...
<span class="date">19/09/2018</span>
            ...
            <div class="content-wrap">
                <section id="thoi-su" class="category skin1">
                    ...
                    <div class="top">
                        ...
                        <article class=" haschart" topic-id="2020,2223,3880">
                            <header>
                                <p class="title">
                ...
                <section id="kinh-doanh" class="category skin1">
                    ...
                    <article class="aside " topic-id="2020,4230">
                        <p class="type"></p>
                        <div class="cover">
                ...
                <section id="phap-luat" class="category skin1">
                    ...
                    <article class="featured " topic-id="2246">
                        <p class="type"></p>
                        <header>
                            <p class="title">
                                <a href="/cha-nhot-3-con-nho-trong-phong-ngu-cham-lua-dot-post878212.html">
                                    Cha nhốt 3 con nhỏ trong phòng ngủ, châm lửa đốt
                                </a>
                            </p>
                            <time datetime="2018-09-19 20:42+0700"></time>
                        </header>
                        <div class="cover">
                            <a href="/cha-nhot-3-con-nho-trong-phong-ngu-cham-lua-dot-post878212.html">
                                <img src="https://znews-photo-td.zadn.vn/w210/Uploaded/mdf_neymvf/2018_09_19/giaicuu.jpg" alt="Cha nhot 3 con nho trong phong ngu, cham lua dot hinh anh" title="Cha nhốt 3 con nhỏ trong phòng ngủ, châm lửa đốt hình ảnh">
                            </a>
                            &nbsp;
                        </div>
                        <p class="summary">Sau khi đánh vợ nhập viện, Quân nhốt 3 con nhỏ trong phòng ngủ rồi chất quần áo, châm lửa đốt. Rất may công an kịp thời có mặt giải cứu.</p>
                        <ul class="relate">
                            <li class="">
                                <a href="/gian-ban-gai-9x-tam-xang-doa-tu-thieu-post861691.html">
                                    Giận bạn gái, 9X tẩm xăng dọa tự thiêu</a></li>
                        </ul>
                    </article>
                    <div class="top">
                ...
                <section id="the-thao" class="category skin2">
                    ...
                    <article class="featured hasvideo" topic-id="2001,2020,2369">
                        <div class="cover">
                            <a href="/hagl-gio-phai-lo-tru-hang-sau-tran-thua-clb-ha-noi-post878222.html">
                    ...
                    <div class="top">
                        <article class="" topic-id="3575,3994,4157,4294,4527">
                            <div class="cover">
                        ...
                        <article class="" topic-id="3927">
                            <header>
                                <p class="title">
                                    <a href="/khi-1-ty-euro-van-chua-the-giup-psg-tro-thanh-ba-chu-post878179.html">
                                        Khi 1 tỷ euro vẫn chưa thể giúp PSG trở thành bá chủ
                                    </a>
                                </p>
                            </header>
                            <p class="summary">Gục ngã trước Liverpool, PSG một lần nữa thể hiện bộ mặt cũ kỹ. Bộ áo đắt tiền được giới chủ Trung Đông khoác trên người chưa thể giúp đội bóng Pháp trở thành bá chủ.
                            </p>
                        </article>
                        <article class=" video" >
                            <header>
                                <p class="title">
                                    <a href="/video-highlights-clb-nam-dinh-roi-san-lach-tray-voi-1-diem-quy-gia-post878234.html">
                                        Highlights CLB Nam Định rời sân Lạch Tray với 1 điểm quý giá
                                    </a>
                                </p>
                            </header>
                            <p class="summary">Cú đá trên chấm 11 m vào phút thi đấu chính thức cuối cùng giúp CLB Nam Định rời sân Lạch Tray của Hải Phòng với 1 điểm sau trận đấu tại vòng 23 V.League.</p>
                        </article>
                        <article class="" >
                            <header>
                                <p class="title">
                ...
                <section id="song-tre" class="category skin1">
                    ...
                    <article class="aside hasvideo" topic-id="2020,3919,4590,4613">
                        <p class="type"></p>
                        <div class="cover">
                            <a href="/ai-co-suc-hut-nhat-tren-mang-trong-top-3-hoa-hau-viet-nam-2018-post877498.html">
                ...
                <section id="suc-khoe" class="category skin1">
                    ...
                    <div class="top">
                        <article class="" >
                            <header>
                                <p class="title">
                                    <a href="/trien-khai-benh-an-dien-tu-tren-toan-quoc-tu-nam-2021-post878214.html">
                                        Triển khai bệnh án điện tử trên toàn quốc từ năm 2021
                                    </a>
                                </p>
                                <time datetime="2018-09-19 20:35+0700"></time>
                            </header>
                        </article>
                ...
                <section id="du-lich" class="category skin1">
                    ...
                    <article class="featured picture noads" topic-id="2002,2020,4465">
                        <p class="type"></p>
                        <header>
                            <p class="title">
                    ...
                    <div class="top">
                        <article class=" picture" topic-id="3535,4467,4465">
                            <header>
                                <p class="title">
                                    <a href="/han-mac-tu-va-giai-nhan-mong-cam-tung-ngam-trang-o-dau-post878012.html">
                                        Hàn Mặc Tử và giai nhân Mộng Cầm từng ngắm trăng ở đâu?
                                    </a>
                                </p>
                                <time datetime="2018-09-19 20:44+0700"></time>
                            </header>
                        </article>
                ...
                <section id="am-thuc" class="category skin1">
                    ...
                    <article class="featured video" topic-id="2020">
                        <p class="type"></p>
                        <header>
                            <p class="title">
                                <a href="/video-piranha-nuong-mon-an-dang-so-cua-tho-dan-amazon-post877864.html">
        ...
        <section class="sidebar">
            ...
            <section class="order-list">
                ...
                <article topic-id="2001,2020,2208,2225,2657,4150,4441">
