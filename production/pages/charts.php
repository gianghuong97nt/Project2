    ...
    <div class="chart-main-block">
        <div class="chart-first-line">
            <div class="col-md-6 chart-blo-1">
                <div class="dygno">
                    ...
                    <canvas id="doughnut" height="300" width="420" style="width: 420px; height: 300px;"></canvas>
                    <script>
                        var doughnutData = [
                            {
                                value: 30,
            ...
            <div class="col-md-6 chart-blo-1">
                <div class="line-chart">
                    <h3>Line Chart</h3>
                    <canvas id="line" height="300" width="410" style="width: 410px; height: 300px;"> </canvas>
                    <script>
                        var lineChartData = {
                            labels : ["","","","","","",""],
                            datasets : [
        ...
        <div class="chart-second-line">
            <div class="col-md-6 chart-blo-1">
                <div class="polararea">
                    <h3>Polar Chart</h3>
                    <canvas id="polarArea" height="270" width="400" style="width: 400px; height: 270px;"></canvas>
                    <script>
                        var chartData = [
                            {
                                value : Math.random(),
